...
# -----------------------------
# Auto-start tmux session (deactive as switched to wezterm and using its own multiplexer)
# -----------------------------
# [[ -z "$TMUX" ]] && exec tmux
...
# . "$HOME/.atuin/bin/env" -- File does not exits (Don't know if required but works perfectly fine without it)
eval "$(atuin init zsh)"
...
zle -N archive_and_execute
bindkey '^M' archive_and_execute
